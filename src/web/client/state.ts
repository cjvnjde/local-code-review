export const SVG={
  ...
  reload:'<svg class="i" viewBox="0 0 16 16" aria-hidden="true"><path d="M13.1 4.2A6 6 0 1 0 14 10h-1.7a4.4 4.4 0 1 1-.6-4.5L9.5 7.7H15V2.2z"/></svg>',
  ...
  panel:'<svg class="i" viewBox="0 0 16 16" aria-hidden="true"><path d="M2.2 3.2h11.6v9.6H2.2z" fill="none" stroke="currentColor" stroke-width="1.4"/><path d="M6.1 3.9h1.3v8.2H6.1z"/></svg>',
  panelOff:'<svg class="i" viewBox="0 0 16 16" aria-hidden="true"><path d="M2.2 3.2h11.6v9.6H2.2z" fill="none" stroke="currentColor" stroke-width="1.4"/></svg>',
  ...
  pic:'<svg class="i" viewBox="0 0 16 16" aria-hidden="true"><path d="M2.2 2.8h11.6v10.4H2.2z" fill="none" stroke="currentColor" stroke-width="1.4"/><path d="M5.5 5.9a1.3 1.3 0 1 1 0 2.6 1.3 1.3 0 0 1 0-2.6z"/><path d="M3.4 12.1l3.1-3.4 1.9 2.1 2.2-2.5 2.4 3.8z"/></svg>',
